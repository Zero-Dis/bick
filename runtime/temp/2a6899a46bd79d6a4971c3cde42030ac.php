<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp\www\bick\public/../application/admin\view\link\link_list.html";i:1493091489;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('link_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                            ...
                            <tbody>
                                <?php if(is_array($links) || $links instanceof \think\Collection || $links instanceof \think\Paginator): $i = 0; $__LIST__ = $links;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="<?php echo url('link_edit',array('id'=>$link['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                            </a>
                                            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('link_del',array('id'=>$link['id'])); ?>')" class="btn btn-danger btn-sm shiny">
