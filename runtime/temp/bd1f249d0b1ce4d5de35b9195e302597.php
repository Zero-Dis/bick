<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp\www\bick\public/../application/admin\view\admin\admin_list.html";i:1493091310;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('admin_add'); ?>'"><i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td align="center" width="15%"><?php echo $vo['id']; ?></td>
                                            <td align="center"><?php echo $vo['name']; ?></td>
                                            <td align="center"><?php echo $vo['group']; ?></td>
                                            <td align="center" width="30%">
                                                <a href="<?php echo url('admin_edit',array('id'=>$vo['id'])); ?>"
                                                   class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#"
                                                   onClick="warning('确实要删除吗', '<?php echo url('admin_del',array('id'=>$vo['id'])); ?>')"
