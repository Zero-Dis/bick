<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\wamp\www\bick\public/../application/admin\view\conf\conf_add.html";i:1493091439;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" required="" name="enname" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="values" class="form-control" placeholder="用逗号分隔"></textarea>
                                            </div>
                                        </div>
