<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp\www\bick\public/../application/admin\view\article\article_list.html";i:1493092505;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('article_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($arts) || $arts instanceof \think\Collection || $arts instanceof \think\Paginator): $i = 0; $__LIST__ = $arts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php
                                            echo mb_substr($vo['title'],0,8,'utf-8');
                                            if(strlen($vo['title'])>10)echo '...';
                                            ?>
                                        </td>
                                        <td align="center">
                                            <?php if($vo['thumb'] != ''): ?>
                                            <img src="__IMG__/<?php echo $vo['thumb']; ?>" width="50">
                                            <?php else: ?>
                                            暂无缩略图
                                            <?php endif; ?>
                                        </td>
                                        <td align="center"><?php echo $vo['author']; ?></td>
                                        <td align="center"><?php if($vo['rec'] == 1): ?>推荐<?php else: ?>不推荐<?php endif; ?></td>
                                        <td align="center"><?php echo $vo['catename']; ?></td>
                                        <td align="center">
                                            <a href="<?php echo url('article_edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                            </a>
                                            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('article_del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
