<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\wamp\www\bick\public/../application/admin\view\conf\conf.html";i:1492590348;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                    ...
                                    <form action="" method="post">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <?php if($v['type']==1):?>
                                                    <input name="<?php echo $v['enname'];?>" type="text"
                                                           class="form-control" style="width:620px;"
                                                           value="<?php echo $v['value'];?>">
                                                    <?php elseif($v['type']==2):?>
                                            <textarea name="<?php echo $v['enname'];?>" class="form-control"
                                                      align="left" style="width:620px;">
                                                <?php echo $v['value'];?>
                                            </textarea>
                                                    <?php elseif($v['type']==3):
                                            if($v['values']){
                                            ...
                                            foreach ($arrradio as $k1 => $v1):
                                                    ...
                                                    <label style="margin-right:15px;">
                                                        <input <?php if($v['value']==$v1){echo 'checked="checked"';} ?>
                                                        name="<?php echo $v['enname'];?>" value="<?php echo $v1;?>"
                                                        type="radio">
                                                        <span class="text"><?php echo $v1;?></span>
                                                    </label>
                                                    <?php endforeach;elseif($v['type']==4):?>
                                                    <label>
                                                        <input <?php if($v['value']==$v['values']){echo 'checked="checked"';} ?>
                                                        name="<?php echo $v['enname'];?>" class="colored-success"
                                                        value="<?php echo $v['values'];?>" type="checkbox">
                                        ...
                                        ?>
                                                    <select name="<?php echo $v['enname'];?>">
                                                        ...
                                                        <option
                                                        <?php if($v['value']==$v2){echo 'selected="selected"';} ?>
                                        ...
                                        <div align="right"><input class="btn btn-primary btn-sm shiny"
                                                                  style="margin-right:52%; margin-top:10px;"
                                                                  type="submit" value="提交修改"></div>
                                    </form>
                                </div>
                                <div>
                                </div>
