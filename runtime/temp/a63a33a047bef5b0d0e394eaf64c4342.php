<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp\www\bick\public/../application/admin\view\admin\admin_edit.html";i:1493091302;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('admin_list'); ?>">管理员管理</a>
                    </li>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">管理员分组</label>
                                            <div class="col-sm-6">
                                                <select name="group_id">
                                                    ...
                                                    <?php if(is_array($groups) || $groups instanceof \think\Collection || $groups instanceof \think\Paginator): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?>
                                                        <option <?php if($group['id'] == $name['group_id']): ?>selected="selected"<?php endif; ?> value="<?php echo $group['id']; ?>"><?php echo $group['title']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="name" placeholder="" name="name"
                                                       required="" value="<?php echo $name['name']; ?>" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
