<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\wamp\www\tp5\public/../application/index\view\index\index.html";i:1492593137;s:67:"D:\wamp\www\tp5\public/../application/index\view\common\header.html";i:1490942988;s:67:"D:\wamp\www\tp5\public/../application/index\view\common\footer.html";i:1490943069;}*/ ?>
...
<div id="select_btn">
    ...
    <img src="__PUBLIC__/images/1-140206160415Y6.jpg" alt="COACH再度携手王力宏 踩单车演" width="255px" height="420px"></a>
            ...
            <div id="picshow_right_cover" onclick="goanewurl()" style="cursor:pointer;position:absolute;top:495px;font-size:14px;width:213px;height:45px;line-height:45px;padding-left:42px;color:#ffffff;zoom:1;background-image:url(__PUBLIC__/images/focus-left-bg.png); background-repeat:no-repeat; background-color:#01A1ED;"></div>
            </div>
        </div>
    </div>
    <div id="xh_container">
...
<div class="xh_post_h_3 ofh">
            ...
            <div id="pagination"><div class='wp-pagenavi'> <a href="/lookbike/" style='float:right;'><img src='__PUBLIC__/images/next01.png' id='next-page'></a></div></div>
        </div>
        <div id="xh_sidebar">
...
<div style="float:right;width:145px;height:52px; overflow:hidden;"><a href="/news/398.html" target="_blank" title="爱车出行新概念 YAKIMA与WHISPBAR将在中国自行车展同台亮相">爱车出行新概念 YAKIMA与WHISPBAR将在中国自</a></div>
    ...
    <script type="text/javascript">
        ...
        $("#next-page").hover(function () { $(this).attr("src", "__PUBLIC__/images/next02.png"); }, function () { $(this).attr("src", "__PUBLIC__/images/next01.png"); });
        $("#last-page").hover(function () { $(this).attr("src", "__PUBLIC__/images/last02.png"); }, function () { $(this).attr("src", "__PUBLIC__/images/last01.png"); });
