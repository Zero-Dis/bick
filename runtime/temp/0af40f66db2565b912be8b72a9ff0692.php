<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp\www\tp5\public/../application/admin\view\link\link_add.html";i:1493091474;s:64:"D:\wamp\www\tp5\public/../application/admin\view\common\top.html";i:1491465151;s:65:"D:\wamp\www\tp5\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('link_list'); ?>">链接管理</a>
                    </li>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">链接标题</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="url" required="" value="http://" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">链接描述</label>
                                            <div class="col-sm-6">
