<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\wamp\www\bick\public/../application/admin\view\auth_group\authgroup_add.html";i:1493091340;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                                ...
                                                <p class="help-block col-sm-4 red">
                                                    <label>
                                                        <input class="checkbox-slider colored-darkorange" name="status"
                                                               value="1" checked="checked" type="checkbox">
                                                        ...
                                                        <td>
                                                            <label>
                                                                ...
                                                                <input name="rules[]" value="<?php echo $authRule['id']; ?>"
                                                                       dataid="id-<?php echo $authRule['dataid']; ?>"
                                                                       class="inverted checkbox-parent <?php if($authRule['level'] != 0): ?> checkbox-child <?php endif; ?> "
                                                                type="checkbox">
