<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\wamp\www\bick\public/../application/admin\view\auth_rule\authrule_list.html";i:1493091376;s:65:"D:\wamp\www\bick\public/../application/admin\view\common\top.html";i:1491465151;s:66:"D:\wamp\www\bick\public/../application/admin\view\common\left.html";i:1493084958;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加权限" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('authRule_add'); ?>'"><i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                    ...
                                    <form action="" method="post">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><input name="<?php echo $authRule['id']; ?>" type="text"
                                                                          style="width:50px; text-align:center;"
                                                                          value="<?php echo $authRule['sort']; ?>"></td>
                                                <td><?php if($authRule['level']!=0){echo '|';} echo str_repeat('—', $authRule['level']*3)?>
                                                    <?php echo $authRule['title']; ?>
                                                </td>
                                                <td><?php echo $authRule['name']; ?></td>
                                                <td align="center"><?php echo $authRule['level']+1; ?>级</td>
                                                <td align="center">
                                                    <a href="<?php echo url('authRule_edit',array('id'=>$authRule['id'])); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗', '<?php echo url('authRule_del',array('id'=>$authRule['id'])); ?>')"
                                        ...
                                        <div><input class="btn btn-primary btn-sm shiny"
                                                    style="margin-left:140px; margin-top:10px;" type="submit"
                                                    value="排序"></div>
                                    </form>
                                </div>
                                <div>
