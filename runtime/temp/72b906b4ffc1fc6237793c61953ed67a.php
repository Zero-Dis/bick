<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp\www\bick\public/../application/index\view\index\index.html";i:1493713500;s:68:"D:\wamp\www\bick\public/../application/index\view\common\header.html";i:1494468847;s:68:"D:\wamp\www\bick\public/../application/index\view\common\footer.html";i:1493713848;}*/ ?>
...
<div id="xh_wrapper">
        ...
        <div class="xh_h_show_in">
                ...
                <div id="picshow">
                    <div id="picshow_img">
                        <ul>
                            ...
                            <li style="display: list-item;"><a href="<?php echo url('Article/article',array('artid'=>$rec_art['id'])); ?>" target="_blank">
                                <img src="__IMG__/<?php echo $rec_art['thumb']; ?>" alt="<?php echo $rec_art['title']; ?>"></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <li style="display: list-item;"><a href="/life/364.html" target="_blank">
                                <img src="__PUBLIC__/images/1-1402061A315209.jpg" alt="隆猫西班牙自行车之旅-Mallorca岛梦幻旅程（上）"></a>
                            </li>
                            <li style="display: list-item;"><a href="/gear/rs/320.html" target="_blank">
                                <img src="__PUBLIC__/images/1-1402061A155W4.jpg"
                                     alt="#CES展上的新玩意# Casio 发布 STB-1000 智能手表 可同步骑行速"></a></li>-->
                        </ul>
                    </div>
                </div>
                <div id="select_btn">
            ...
            <div id="picshow_right">
                <a href="/life/416.html" target="_blank">
                    <img src="__PUBLIC__/images/1-140206160415Y6.jpg" alt="COACH再度携手王力宏 踩单车演" width="255px"
                         height="420px"></a>

                <div id="picshow_right_cover" onclick="goanewurl()"
                     style="cursor:pointer;position:absolute;top:495px;font-size:14px;width:213px;height:45px;line-height:45px;padding-left:42px;color:#ffffff;zoom:1;background-image:url(__PUBLIC__/images/focus-left-bg.png); background-repeat:no-repeat; background-color:#01A1ED;"></div>
            </div>
        </div>
    </div>
    <div id="xh_container">
        ...
        <div id="xh_content" style="padding-right:10px;">
            <div class="xh_area_h_3">
                <div class="xh_area_title">
                    ...
                    <?php if(is_array($res_index_cates) || $res_index_cates instanceof \think\Collection || $res_index_cates instanceof \think\Paginator): $i = 0; $__LIST__ = $res_index_cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res_index_cate): $mod = ($i % 2 );++$i;?>
                    <a href="<?php if($res_index_cate['type'] == 1): ?><?php echo url('Artlist/artlist',array('cateid'=>$res_index_cate['id'])); elseif($res_index_cate['type'] == 2): ?><?php echo url('Page/page',array('cateid'=>$res_index_cate['id'])); else: ?><?php echo url('Imglist/imglist',array('cateid'=>$res_index_cate['id'])); endif; ?>"><?php echo $res_index_cate['catename']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <?php if(is_array($index_arts) || $index_arts instanceof \think\Collection || $index_arts instanceof \think\Paginator): $i = 0; $__LIST__ = $index_arts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$index_art): $mod = ($i % 2 );++$i;?>
                <div class="xh_post_h_3 ofh">
                    <div class="xh_265x265">
                        <a target="_blank" href="<?php echo url('Article/article',array('artid'=>$index_art['id'])); ?>"
                           title="<?php echo $index_art['title']; ?>">
                            <img src="__IMG__/<?php echo $index_art['thumb']; ?>" alt="<?php echo $index_art['title']; ?>" height="240" width="400"></a>
                    </div>
                    <div class="r ofh">
                        <h2 class="xh_post_h_3_title ofh">
                            <a target="_blank" href="<?php echo url('Article/article',array('artid'=>$index_art['id'])); ?>"
                               title="<?php echo $index_art['title']; ?>"><?php echo $index_art['title']; ?></a>
                        </h2>
                        <span class="time"><?php echo date("Y年m月d日 H:i",$index_art['time']); ?></span>

                        <div class="xh_post_h_3_entry ofh">
                            <?php echo $index_art['desc']; ?>
                        </div>
                        <div class="b">
                            <span title="<?php echo $index_art['zan']; ?>人赞" class="xh_love"><span class="textcontainer"><span><?php echo $index_art['zan']; ?></span></span> <span
                                    class="bartext"></span></span> <span title="<?php echo $index_art['click']; ?>人浏览" class="xh_views"><?php echo $index_art['click']; ?></span>
                        </div>
                    </div>
                    <span class="cat"><a href="#" rel="category tag"><?php echo $index_art['catename']; ?></a></span>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <!--<div class="xh_post_h_3 ofh">
                    <div class="xh_265x265">
                        <a target="_blank" href="/life/395.html" title="骑看世界：探索地中海科西嘉岛">
                            <img src="__PUBLIC__/images/355.jpg" alt="骑看世界：探索地中海科西嘉岛" height="240" width="400"></a>
                    </div>
                    <div class="r ofh">
                        <h2 class="xh_post_h_3_title ofh">
                        ...
                        <div class="b">
                            <span title="1人赞" class="xh_love"><span class="textcontainer"><span>1</span></span> <span
                                    class="bartext"></span></span> <span title="180人浏览" class="xh_views">180</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    <div class="xh_265x265">
                        <a target="_blank" href="/gear/rs/360.html"
                           title=" Forward Set x Bicycle Belts联合出品U型锁腰带U-Lock Belt">
                            <img src="__PUBLIC__/images/320.jpg" alt=" Forward Set x Bicycle Belts联合出品U型锁腰带U-Lock Belt"
                                 height="240" width="400"></a></div>
                    <div class="r ofh">
                        <h2 class="xh_post_h_3_title ofh">
                            <a target="_blank" href="/gear/rs/360.html"
                               title=" Forward Set x Bicycle Belts联合出品U型锁腰带U-Lock Belt"> Forward Set x Bicycle
                        ...
                        <div class="b">
                            <span title="1人赞" class="xh_love"><span class="textcontainer"><span>1</span></span> <span
                                    class="bartext"></span></span> <span title="144人浏览" class="xh_views">144</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    <div class="xh_265x265">
                        <a target="_blank" href="/gear/accessories/359.html" title="硅胶环保材质 Bone iPhone5 单车号角扬声器">
                            <img src="__PUBLIC__/images/319.jpg" alt="硅胶环保材质 Bone iPhone5 单车号角扬声器" height="240"
                                 width="400"></a></div>
                    <div class="r ofh">
                        <h2 class="xh_post_h_3_title ofh">
                            <a target="_blank" href="/gear/accessories/359.html" title="硅胶环保材质 Bone iPhone5 单车号角扬声器">硅胶环保材质
                                Bone iPhone5 单车号角扬声器</a>
                        </h2>
                        ...
                        <div class="b">
                            <span title="1人赞" class="xh_love"><span class="textcontainer"><span>1</span></span> <span
                                    class="bartext"></span></span> <span title="62人浏览" class="xh_views">62</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    <div class="xh_265x265">
                        <a target="_blank" href="/lookbike/bmx/240.html"
                           title="Alain Massabova: 40 Years in Paris BMX 视频">
                            <img src="__PUBLIC__/images/200.jpg" alt="Alain Massabova: 40 Years in Paris BMX 视频"
                                 height="240" width="400"></a></div>
                    <div class="r ofh">
                        <h2 class="xh_post_h_3_title ofh">
                            <a target="_blank" href="/lookbike/bmx/240.html"
                               title="Alain Massabova: 40 Years in Paris BMX 视频">Alain Massabova: 40 Years in Paris BMX
                                视频</a>
                        </h2>
                        <span class="time">2014年02月06日 17:25</span>
                        ...
                        <div class="b">
                            <span title="0人赞" class="xh_love"><span class="textcontainer"><span>0</span></span> <span
                                    class="bartext"></span></span> <span title="88人浏览" class="xh_views">88</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    ...
                    <div class="r ofh">
                        ...
                        <div class="b">
                            <span title="0人赞" class="xh_love"><span class="textcontainer"><span>0</span></span> <span
                                    class="bartext"></span></span> <span title="102人浏览" class="xh_views">102</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    ...
                    <div class="r ofh">
                        ...
                        <div class="b">
                            <span title="0人赞" class="xh_love"><span class="textcontainer"><span>0</span></span> <span
                                    class="bartext"></span></span> <span title="157人浏览" class="xh_views">157</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    ...
                    <div class="r ofh">
                        ...
                        <div class="b">
                            <span title="0人赞" class="xh_love"><span class="textcontainer"><span>0</span></span> <span
                                    class="bartext"></span></span> <span title="181人浏览" class="xh_views">181</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    ...
                    <div class="r ofh">
                        ...
                        <div class="b">
                            <span title="1人赞" class="xh_love"><span class="textcontainer"><span>1</span></span> <span
                                    class="bartext"></span></span> <span title="171人浏览" class="xh_views">171</span>
                        </div>
                    </div>
                ...
                <div class="xh_post_h_3 ofh">
                    ...
                    <div class="r ofh">
                        ...
                        <div class="b">
                            <span title="7人赞" class="xh_love"><span class="textcontainer"><span>7</span></span> <span
                                    class="bartext"></span></span> <span title="68人浏览" class="xh_views">68</span>
                        </div>
                    </div>
            ...
            <!--<div id="pagination">
                <div class='wp-pagenavi'><a href="/lookbike/" style='float:right;'><img
                        src='__PUBLIC__/images/next01.png' id='next-page'></a></div>
            </div>-->
        </div>
        <div id="xh_sidebar">
            ...
            <div class="widget">
                ...
                <ul id="ulHot">
                    <?php if(is_array($hot_arts) || $hot_arts instanceof \think\Collection || $hot_arts instanceof \think\Paginator): $i = 0; $__LIST__ = $hot_arts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot_art): $mod = ($i % 2 );++$i;?>
                    <li style="border-bottom:dashed 1px #ccc;height:70px; margin-bottom:15px;">
                        <div style="float:left;width:85px;height:55px; overflow:hidden;"><a
                                href="<?php echo url('Article/article',array('artid'=>$hot_art['id'])); ?>" target="_blank"><img
                                src="__IMG__/<?php echo $hot_art['thumb']; ?>" width="83" title="<?php echo $hot_art['title']; ?>"/></a>
                        </div>
                        <div style="float:right;width:145px;height:52px; overflow:hidden;"><a
                                href="<?php echo url('Article/article',array('artid'=>$hot_art['id'])); ?>" target="_blank"
                                title="<?php echo $hot_art['title']; ?>"><?php echo $hot_art['title']; ?></a></div>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <!--<li style="border-bottom:dashed 1px #ccc;height:70px; margin-bottom:15px;">
                        <div style="float:left;width:85px;height:55px; overflow:hidden;"><a
                    ...
                    <li style="border-bottom:dashed 1px #ccc;height:70px; margin-bottom:15px;">
                        <div style="float:left;width:85px;height:55px; overflow:hidden;"><a href="/life/368.html"
                                                                                            target="_blank"><img
                                src="__PUBLIC__/images/327.jpg" width="83" title="骑摆记：比利时车手Joris的尼泊尔野马河谷山地车之旅"/></a>
                        </div>
                        <div style="float:right;width:145px;height:52px; overflow:hidden;"><a href="/life/368.html"
                                                                                              target="_blank"
                                                                                              title="骑摆记：比利时车手Joris的尼泊尔野马河谷山地车之旅">骑摆记：比利时车手Joris的尼泊尔野马河谷山</a>
                        </div>
                    </li>
                    <li style="border-bottom:dashed 1px #ccc;height:70px; margin-bottom:15px;">
                        <div style="float:left;width:85px;height:55px; overflow:hidden;"><a href="/life/378.html"
                                                                                            target="_blank"><img
                                src="__PUBLIC__/images/335.jpg" width="83" title="深圳设计师浩子和77的11天成都-稻城自虐骑行"/></a></div>
                    ...
                    <li style="border-bottom:dashed 1px #ccc;height:70px; margin-bottom:15px;">
                        <div style="float:left;width:85px;height:55px; overflow:hidden;"><a href="/news/398.html"
                                                                                            target="_blank"><img
                                src="__PUBLIC__/images/359.jpg" width="83" title="爱车出行新概念 YAKIMA与WHISPBAR将在中国自行车展同台亮相"/></a>
                        </div>
                        <div style="float:right;width:145px;height:52px; overflow:hidden;"><a href="/news/398.html"
                                                                                              target="_blank"
                                                                                              title="爱车出行新概念 YAKIMA与WHISPBAR将在中国自行车展同台亮相">爱车出行新概念
            ...
            <div class="widget portrait">
                <div>
                    <div class="textwidget">
                        <a href="/tougao.html"><img src="__PUBLIC__/images/tg.jpg" alt="投稿"></a><br><br>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $("#next-page").hover(function () {
            $(this).attr("src", "__PUBLIC__/images/next02.png");
        }, function () {
            $(this).attr("src", "__PUBLIC__/images/next01.png");
        });
        $("#last-page").hover(function () {
            $(this).attr("src", "__PUBLIC__/images/last02.png");
        }, function () {
            $(this).attr("src", "__PUBLIC__/images/last01.png");
        });
    ...
    <div class="l">
        <ul id="menu-sitemap" class="menu">
            ...
            <li class="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" href="<?php if($cate['type'] == 1): ?><?php echo url('Artlist/artlist',array('cateid'=>$cate['id'])); elseif($cate['type'] == 2): ?><?php echo url('Page/page',array('cateid'=>$cate['id'])); else: ?><?php echo url('Imglist/imglist',array('cateid'=>$cate['id'])); endif; ?>"><?php echo $cate['catename']; ?></a>
                <?php if($cate['ccate'] != 0): ?>
                <ul class="sub-menu">
                    <?php foreach($cate['ccate'] as $k=>$v):?>
                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category">
                        <a target="_blank"
                           href="<?php echo url('Artlist/artlist',array('cateid'=>$v['id'])); ?>"><?php echo $v['catename'];?></a>
                    </li>
                    <?php endforeach?>
                    <!--<li class="menu-item menu-item-type-taxonomy menu-item-object-category">
